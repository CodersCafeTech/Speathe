...
def findexact(msg_array,morse):    # function that checks if content of msg_array and morse are an exact match
    i=0
...
def findexactword(wrd_array,word):    # function that checks if content of wrd_array and word are an exact match
    j=0
...
def insert_wrd(wrd_array,letter):    # function that concatinates word input
    ...
    wrd_counter+=1
    f = open("istyping.txt", "w")
    f.write(str(wrd_counter))
...
#Short command checking by giving a function call to 'findexactword()' , if returns true then: text to speech output using 'e-speak'
    global msgText
    if (findexactword(wrd_array,fud)==1):
        print('Get me food')
        msgText='Get me food'
        f = open("speathe.txt", "w")
        f.write(msgText)
        #os.system("espeak 'Get me food'")
        wrd_counter=0
        clear_wrdar()
    ...
    elif (findexactword(wrd_array,wtr)==1):
        print('I want water')
        msgText='I want water'
        f = open("speathe.txt", "w")
        f.write(msgText)
        #os.system("espeak 'I want water'")
        wrd_counter=0
        clear_wrdar()
    elif (findexactword(wrd_array,gis)==1):
        print('Get in soon')
        msgText='Get in soon'
        f = open("speathe.txt", "w")
        f.write(msgText)
        #os.system("espeak 'Get in soon'")
        wrd_counter=0
        clear_wrdar()
    elif (findexactword(wrd_array,tlt)==1):
        print('Take me to toilet')
        msgText='Take me to toilet'
        f = open("speathe.txt", "w")
        f.write(msgText)
        #os.system("espeak 'Take me to toilet'")
        wrd_counter=0
        clear_wrdar()
